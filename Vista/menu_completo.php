    ...
    <div class="col-md-10 menu navbar navbar-expand-md navbar-light">
      ...
      <div class="collapse navbar-collapse" id="uno">
        ...
        <li class="nav-item dropdown active">
          <a class="nav-link dropdown-toggle text-light" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="#">Agregar Médico</a>
              <a class="dropdown-item" href="#">Consultar Médicos</a>
              <a class="dropdown-item" href="#">Editar Médicos</a>
            </div>
        </li>
        ...
        <li class="nav-item dropdown active text-light">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <a class="dropdown-item" href="#">Agregar Pacientes</a>
            <a class="dropdown-item" href="#">Consultar Pacientes</a>
            <a class="dropdown-item" href="#">Editar Pacientes</a>
          </div>
        </li>
        ...
        <li class="nav-item dropdown nav-item active">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <a class="dropdown-item" href="#">Reportes de Medicos</a>
            <a class="dropdown-item" href="#">Reporte de Pacientes</a>
            <a class="dropdown-item" href="#">Reporte de Citas atendidas</a>
          </div>
        </li>
